...
input int      MagicNumber = 270403;  // Magic number v27.4.3
...
void CreateDashboard()
{
   ...
   ObjectSetString(0, "Dashboard_Title", OBJPROP_TEXT, "EA SCALPING v27.4.3");
