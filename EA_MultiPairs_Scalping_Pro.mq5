...
input int      MagicNumber = 270501;  // Magic number v27.5.1
...
void CreateDashboard()
{
   ...
   ObjectSetString(0, "Dashboard_Title", OBJPROP_TEXT, "EA SCALPING v27.5.1");
