...
input int      MagicNumber = 270510;  // Magic number v27.51
...
void CreateDashboard()
{
   ...
   ObjectSetString(0, "Dashboard_Title", OBJPROP_TEXT, "EA SCALPING v27.51");
